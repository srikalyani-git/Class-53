...
def topwin():
    ...
    win.config(bg="grey")
    title = Label(win,text="Enter Amount", fg="black",bg="grey")
    input = Entry(win)
    ...
    input.place(x=220,y=80)
    en500.place(x=270,y=170)
    en200.place(x=270,y=200)
    en100.place(x=270,y=230)
    en50.place(x=270,y=260)
    en10.place(x=270,y=290)
    en5.place(x=270,y=320)
    en1.place(x=270,y=350)
